      ...
      <div class="sidebar">
          ...
          <div class="sidebar-content">
            ...
            <div class="dropdown" style="color:black;">
              <button><a href="#/"><img src="ECommerce.png" style="width:100px;">E-Commerce Admin Page</a></button>
              <div class="dropdown-content">
                <a href="#" style="color:black;">Customize your own dashboard</a>
                <a href="#" style="color:black;">Settings</a>
              </div>
            </div>
            <p style="color:white;"><button><a href="#">Profile</a></button></p>
            <p style="color:white;"><button><a href="#">Product</a></button></p>
            <p style="color:white;"><button><a href="#">Order</a></button></p>
            <p style="color:white;"><button><a href="#">Shipping</a></button></p>
            <p style="color:white;"><button><a href="#">Transaction</a></button></p>
            <p style="color:white;"><button><a href="#">Sale</a></button></p>
            <p style="color:white;"><button><a href="#">Customer</a></button></p>
            <p style="color:white;"><button><a href="#">Message Inbox</a></button></p>
            <p style="color:white;"><button><a href="#">Promotion</a></button></p>
