<template>
  ...
  <p style="color:white;"><button><a href="#/loghistorian"><img src="LOG.png" style="width:100px;">Log Historian</a></button></p>
    ...
    <div style="text-align: left;">
        <p><u>MQTT Mosquitto</u></p>
        <br>
        <img src="Mosquitto.png" style="width:200px;">
        <br>


        <p><u>AWS IoT Core Endpoint</u></p>
        <br>
        <img src="AWSIoTCore.jpeg" style="width:200px;">
        <br>


        
        <p><u>HTTPS API Endpoint</u></p>
        <br>
        <img src="HTTPS.jpg" style="width:200px;">
        <br>


             
        <p><u>GRPC Endpoint</u></p>
        <br>
        <img src="GRPC.png" style="width:200px;">
        <br>


        <p><u>Web Socket Endpoint</u></p>
        <br>
        <img src="WEBSOCKET.jpg" style="width:200px;">
        <br>

   

        <p><u>Modbus TCP Endpoint</u></p>
        <br>
        <img src="MODBUS.jpg" style="width:200px;">
        <br>

        <p><u>OPC UA Endpoint</u></p>
        <br>
        <img src="OPCUA.png" style="width:200px;">
        <br>

        <p><u>COAP Endpoint</u></p>
        <br>
        <img src="COAP.png" style="width:200px;">
        <br>
