      ...
      <div class="sidebar">
          ...
          <div class="sidebar-content">
            ...
            <div class="dropdown" style="color:black;">
              <button><a href="#/"><img src="WAREHOUSE.png" style="width:100px;">Warehouse Management System (WMS)</a></button>
              <div class="dropdown-content">
                <a href="#" style="color:black;">Option 1</a>
                <a href="#" style="color:black;">Option 2</a>
              </div>
            </div>
            <p style="color:white;"><button><a href="#">Stock Management System</a></button></p>
            <p style="color:white;"><button><a href="#">Automated Warehouse Self-driving Car Management System</a></button></p>
            <p style="color:white;"><button><a href="#">RFID tag management system </a></button></p>
            <p style="color:white;"><button><a href="#">AI Warehouse Optimization</a></button></p>
        ...
        <div class="main" style="margin-top:50px; color:white;">
          <h2>Manufacturing Exceution System (MES) System</h2>
          <br>
          <br>
