    ...
    <div id="app">
      ...
      <div class="sidebar">
          ...
          <div class="sidebar-content">
            <img src="ROBOTARM.png" style="width:100px;">
      
            <div class="dropdown" style="color:black;">
              <button><a href="#/">MES System</a></button>
              <div class="dropdown-content">
                <a href="#" style="color:black;">Option 1</a>
                <a href="#" style="color:black;">Option 2</a>
              </div>
            </div>
            <p style="color:white;"><button><a href="#">Process Flow</a></button></p>
            <p style="color:white;"><button><a href="#">Material </a></button></p>
            <p style="color:white;"><button><a href="#">Robot Arm Status</a></button></p>
            <p style="color:white;"><button><a href="#">Machine Status</a></button></p>
            <p style="color:white;"><button><a href="#">Computer Vision</a></button></p>
