  ...
  <p style="color:white;"><button><a href="#/loghistorian"><img src="LOG.png" style="width:100px;">Log Historian</a></button></p>
    ...
    <section class="pricing-plans">
      <div class="pricing-card basic">
        <div class="heading">
          <h4>Hobbyist</h4>
          <p>Suitable for IoT Hobbyist & University Students</p>
        </div>
        <p class="price">
          Free
          <sub></sub>
        ...
        <ul class="features">
          <li>
            ...
            <strong>MQTT, HTTPS, OPCUA </strong> supported
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>GRPC, CoAP, Modbus TCP</strong> supported
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>IoT SDK </strong>supported
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Third Party API</strong> supported
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Dashboard </strong>provided but no saving
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong></strong>No database
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong></strong>Rate Limit Applied for All
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong></strong>Not support Real Time Transfer (WebSocket)
          </li>
        </ul>
      ...
      <div class="pricing-card standard">
        <div class="heading">
          <h4>Basic</h4>
          <p>Immersed experience at low cost</p>
        </div>
        <p class="price">
          RM50
          <sub>/month</sub>
        ...
        <ul class="features">
          ...
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Third Party API & Database</strong> supported
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Real Time Dashboard </strong>provided up to 20
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Maximum PLC numbers</strong> 100
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Higher Rate Limit Quote</strong> 
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Websocket protocol</strong> supported
          </li>
        </ul>
        <button class="cta-btn">SELECT</button>
      </div>
      <div class="pricing-card premium">
        <div class="heading">
          <h4>PREMIUM</h4>
          <p>Suitable for almost all the use case</p>
        </div>
        <p class="price">
          RM120
          <sub>/month</sub>
        ...
        <ul class="features">
          ...
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Real Time Dashboard </strong>provided up to 100
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Maximum PLC numbers</strong> 1000
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>No Rate Limit</strong> 
          </li>
          
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Mobile Application</strong> support
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Websocket protocol</strong> supported
      ...
      <div class="pricing-card ultimate">
        <div class="heading">
          <h4>Ultimate</h4>
          <p>Dedicated server and resource for extreme condition</p>
        </div>
        <p class="price">
          RM200
          <sub>/month</sub>
        ...
        <ul class="features">
          ...
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Real Time Dashboard </strong>> 100
          </li>
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Maximum PLC numbers</strong>>1000
          ...
          <li>
            <i class="fa-solid fa-check"></i>
            <strong>Dedicated server & resources</strong> supported
          </li>
        </ul>
