      ...
      <div class="sidebar">
          ...
          <div class="sidebar-content">
            ...
            <div class="dropdown" style="color:black;">
              <button><a href="#/"><img src="ERP.jpg" style="width:100px;">Enterprise Resource Plan (ERP)</a></button>
              <div class="dropdown-content">
                <a href="#" style="color:black;">Customize your own dashboard</a>
                <a href="#" style="color:black;">Settings</a>
              </div>
            </div>
            <p style="color:white;"><button><a href="#"><img src="FINANCE.png" style="width:100px;">Finance</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="HR.png" style="width:100px;">Human Resources</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="Manufacturing.png" style="width:100px;">Manufacturing and Production</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="Supply.png" style="width:100px;">Logistics and Supply Chain</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="INVENTORY.png" style="width:100px;">Inventory and Order Management</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="CRM.png" style="width:100px;">Customer Relationship Management</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="SALE.png" style="width:100px;">Sale</a></button></p>
            <p style="color:white;"><button><a href="#"><img src="BI.png" style="width:100px;">Business Intelligence</a></button></p>
        ...
        <div class="main" style="margin-top:50px; color:white;">
          ...
          <br>
          <br>
          <p>Refresh your browser if you're disconnected. Otherwise, you will not get the latest updated data from server</p>
          <table>
              <tr>
                
              <td>Device Number Online</td>
              <td>Total Number Device</td>
          ...
          <!-- -->
          <p>You can select devices up to 20 for real-time display due to the constraint</p>
